...
const PaymentSuccess = () => {
  ...
  const handleWhatsAppContact = () => {
    const phoneNumber = "09161107183"; // Replace with your WhatsApp number
    const message = `Hi! I just completed a payment for order #${orderData?.orderId}. I'd like to confirm some details.`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -right-32 w-64 h-64 bg-green-100 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-emerald-100 rounded-full opacity-20 animate-pulse"></div>
      </div>

      <div className="relative z-20 bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 w-full max-w-md text-center border border-green-100">
        {/* Success Icon */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-blue-700 text-sm">
                  You’ll receive an email with your receipt and tracking info
                  (if applicable).
                </p>
              </div>
            </div>
        ...
        {/* Support Section */}
        <div className="mb-6">
          <p className="text-gray-600 text-sm mb-3 font-medium">Need help?</p>
